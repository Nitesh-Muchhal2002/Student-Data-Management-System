#include<iostream>
using namespace std;
  string roll_no[30],name[30],Branch[30],course[30],mobile_no[30],admission_year[30];
...
{
	 cout<<"-----------------College Student Data -------------------------";
  cout<<"\nPress 1 to Enter  Student data"<<endl<<endl;
  cout<<"Press 2 to Show Student data"<<endl<<endl;
   cout<<"Press 3 to Search Student data"<<endl<<endl;
   cout<<"Press 4 to Update  Student data"<<endl<<endl;
   cout<<"Press 5 to Delete student data"<<endl<<endl;
